...
mixin _$JoinRequestModel {
 ...
 String get id; String get userId; String get teamId; String get status; TeamUserShortModel get user;
...
@useResult
$Res call({
 String id, String userId, String teamId, String status, TeamUserShortModel user
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String userId,  String teamId,  String status,  TeamUserShortModel user)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _JoinRequestModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String userId,  String teamId,  String status,  TeamUserShortModel user)  $default,) {final _that = this;
switch (_that) {
case _JoinRequestModel():
return $default(_that.id,_that.userId,_that.teamId,_that.status,_that.user);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String userId,  String teamId,  String status,  TeamUserShortModel user)?  $default,) {final _that = this;
switch (_that) {
case _JoinRequestModel() when $default != null:
return $default(_that.id,_that.userId,_that.teamId,_that.status,_that.user);case _:
  return null;

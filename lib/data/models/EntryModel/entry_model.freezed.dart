...
mixin _$EntryModel {
 ...
 String get id; String get tournamentId; String get teamId; List<String> get playerIds; EntryStatus get status;
...
@useResult
$Res call({
 String id, String tournamentId, String teamId, List<String> playerIds, EntryStatus status
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String tournamentId,  String teamId,  List<String> playerIds,  EntryStatus status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EntryModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String tournamentId,  String teamId,  List<String> playerIds,  EntryStatus status)  $default,) {final _that = this;
switch (_that) {
case _EntryModel():
return $default(_that.id,_that.tournamentId,_that.teamId,_that.playerIds,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String tournamentId,  String teamId,  List<String> playerIds,  EntryStatus status)?  $default,) {final _that = this;
switch (_that) {
case _EntryModel() when $default != null:
return $default(_that.id,_that.tournamentId,_that.teamId,_that.playerIds,_that.status);case _:
  return null;
...
@override final  EntryStatus status;

...
_TeamUserShortModel _$TeamUserShortModelFromJson(Map<String, dynamic> json) =>
    _TeamUserShortModel(
      id: json['id'] as String,
...
Map<String, dynamic> _$TeamUserShortModelToJson(_TeamUserShortModel instance) =>
    <String, dynamic>{
      'id': instance.id,
...
_TeamShortInfoModel _$TeamShortInfoModelFromJson(Map<String, dynamic> json) =>
    _TeamShortInfoModel(
      id: json['id'] as String,
      name: json['name'] as String,
      tag: json['tag'] as String,
...
Map<String, dynamic> _$TeamShortInfoModelToJson(_TeamShortInfoModel instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
      'tag': instance.tag,
